...
package org.danmayr.imagej.shape_detector;
...
import org.danmayr.imagej.shape_detector.cellMagicWand.CommandLine;
import org.danmayr.imagej.shape_detector.cellMagicWand.Constants;
import org.danmayr.imagej.shape_detector.cellMagicWand.PolarTransform;
...
public class Cell_Magic_Wand_Tool extends PlugInTool {
	...
	public void addNewShape(ImagePlus imp, RoiManager rm,int x, int y) {
		try{
